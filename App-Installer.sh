...
sudo wget -O ./Nginx-Config/trading.conf https://raw.githubusercontent.com/D-Best-Apps/Trading-Card-Game/main/Nginx-Config/trading.conf
...
sudo ln -sf /etc/nginx/sites-available/trading.conf /etc/nginx/sites-enabled/trading.conf
...
sudo wget -O ./entrypoint.sh https://raw.githubusercontent.com/D-Best-Apps/Trading-Card-Game/main/entrypoint.sh
...
sudo wget -O ./.env https://raw.githubusercontent.com/D-Best-Apps/Trading-Card-Game/main/.env
...
echo "You should now be able to access the application via Nginx."